...
export const addParent = async (postBody: any) => {
    return await api
        .post('parents', postBody)
        .then(response => response)
        .catch(e => e.response)
}

export const fetchParents = async (filter: any) => {
    const url = generateUrl('parents', filter)
...
export const updateParent = async (id: string, postBody: any) => {
    return await api
        .patch(`parents/${id}`, postBody)
        .then(response => response)
        .catch(e => e.response)
}
...
export const removeParent = async (id: string) => {
    return await api
        .delete(`parents/${id}`)
        .then(response => response)
        .catch(e => e.response)
